...
Displayscreen(screenid: any,Displayscreen:any) {
  this.session.screen = screenid;this.session.Screen_Name=Displayscreen;

  //this.router.navigate(['/office-module/office-screen']);
}
