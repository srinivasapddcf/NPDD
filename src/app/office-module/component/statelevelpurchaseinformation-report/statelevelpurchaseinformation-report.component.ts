...
@Component({
  selector: 'app-statelevelpurchaseinformation-report',
  standalone: true,
    imports: [CommonModule, TableModule,FormsModule],
  templateUrl: './statelevelpurchaseinformation-report.component.html',
  styleUrl: './statelevelpurchaseinformation-report.component.css'
})
export class StatelevelpurchaseinformationReportComponent {
RegDetails = []; districtId: any;
  input: any;
  constructor(
  ...
  async loadReport(): Promise<void> {
    try { debugger;
      ...
      const req = {
          ...
          const res = await this.OfficeModuleAPI.StatelevelBudget_Select(req);
