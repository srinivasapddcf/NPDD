...
export class BudgetFinancialyearsComponent implements OnInit {
    ...
    async btnSubmitDetails(): Promise<void> {
        ...
        try {
            ...
            if (this.validate()) {
                ...
                if (parseInt(fid.toString()) > parseInt(tid.toString())) { this.toast.warning('Please Select Valid Financial Years'); return; }
    ...
    validate(): boolean {
        ...
        if (this.fromfyID === '' || this.fromfyID === null || this.fromfyID === undefined) {
            this.toast.warning('Please Select Financial From Year');
            return false;
        }

        else if (this.tofyID === '' || this.tofyID === null || this.tofyID === undefined) { this.toast.warning('Please Select Financial To Year'); return false; }


        else if (this.COMPID === '' || this.COMPID === null || this.COMPID === undefined) { this.toast.warning('Please Select Component'); return false; }


        else if (this.SUBCOMPID === '' || this.SUBCOMPID === null || this.SUBCOMPID === undefined) { this.toast.warning('Please Select Sub Component'); return false; }


        else if (this.Units === '' || this.Units === null || this.Units === undefined) { this.toast.warning('Please Enter Units'); return false; }

        else if (this.Amount === '' || this.Amount === null || this.Amount === undefined) { this.toast.warning('Please Enter Amount'); return false; }
