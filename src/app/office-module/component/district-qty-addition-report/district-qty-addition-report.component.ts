...
@Component({
  selector: 'app-district-qty-addition-report',
  templateUrl: './district-qty-addition-report.component.html',
  styleUrls: ['./district-qty-addition-report.component.css']
})
export class DistrictQtyAdditionReportComponent  implements    OnInit, OnDestroy, AfterViewInit {
