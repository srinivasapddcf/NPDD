...
export class PoDistrictQtyAdditionComponent implements OnInit {
  ...
  async btnAddQty():Promise<void>{
    ...
    if(parseFloat(this.Updateqty)>parseFloat(this.GridDataold[0].PO_BALANCE_QUANTITY)   ||  parseFloat(this.Updateamt)>parseFloat(this.GridDataold[0].PO_BALANCE_AMOUNT) )
{
