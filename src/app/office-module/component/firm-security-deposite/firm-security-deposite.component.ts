...
export class FirmSecurityDepositeComponent implements OnInit {
    ...
    validate(): boolean {
        try {
            if (this.FIRMID === '' || this.FIRMID === null || this.FIRMID === undefined) { this.toast.warning('Please Select Firm Name'); return false; }
            if (this.sddate === '' || this.sddate === null || this.sddate === undefined) { this.toast.warning('Please Select Date'); return false; }
            if (this.ctype === '' || this.ctype === null || this.ctype === undefined) { this.toast.warning('Please Select Type'); return false; }
            if (this.ChequeNo === '' || this.ChequeNo === null || this.ChequeNo === undefined) { this.toast.warning('Please Select Cheque No'); return false; }
            if (this.ChequeDate === '' || this.ChequeDate === null || this.ChequeDate === undefined) { this.toast.warning('Please Select Cheque Date'); return false; }
            if (this.deptamount === '' || this.deptamount === null || this.deptamount === undefined) { this.toast.warning('Please Select Deposit Amount'); return false; }
